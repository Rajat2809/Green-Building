...
<head>
    <meta charset="UTF-8">
    <title>Green Building - Register</title>
...
<div>
    <h1>
        This is Salesman Login Page
    </h1>
    <a id="toSignIn" class="scroll goto-btn" href="signIn.php">Sign Out</a>
</div>
...
<script src="../js/commonHeaderFooter.js"></script>
